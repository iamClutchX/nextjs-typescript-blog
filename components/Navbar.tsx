                ...
                <Link href="/">
                  <div className="flex flex-shrink-0 items-center">
                    <Image
                      ...
                      alt="logo"
                    />
                    <h1 className="text-4xl ml-2 bold text-primary">Code Articles</h1>
                  </div>
                </Link>
                  ...
                  <div className="flex space-x-4 mx-auto">
                    {navigation.map((item) => (
                      <a
                        key={item.name}
                        href={item.href}
                        className="text-gray-800 hover:bg-primary hover:text-white px-3 py-3 rounded-md text-sm font-medium"
